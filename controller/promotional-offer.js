...
exports.editPromotionalOfferData = async (req, res, next) => {
    ...
    try {
        ...
        const promoOffers = await PromotionalOfferProduct.find({promotionalOffer: updatedData._id});
        ...
        await PromotionalOfferProduct.updateMany({promotionalOffer: updatedData._id},
            {$set: {promotionalOfferSlug: updatedData.slug}}
        )

        await PromotionalOffer.findOneAndUpdate(query, push);
